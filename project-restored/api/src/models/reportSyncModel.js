...
const getAllReportSyncsWithDetails = async () => {
    const reportSyncs = await pool.query(`
      ...
      JOIN reports r ON rs.report_id = r.id
    `);
    return reportSyncs.rows;
}

module.exports = { getAllReportSyncs, updateReportSyncStatus, getReportSyncFullData, getAllReportSyncsWithDetails };
